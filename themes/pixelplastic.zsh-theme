...
$(xterm_color 33 $(scm_prompt_char))> '
  ...
  *)
    # see http://www.calmar.ws/vim/256-xterm-24bit-rgb-color-chart.html for color codes
    PROMPT_PREFIX="$(term_color '1;37;5;43' '%n')$(term_color '1;36;5;43' '@')$(term_color '1;30;40' '%m')"

    PROMPT='$PROMPT_PREFIX $(term_color "1;32;40" "${PWD/#$HOME/~}") $SCM_PROMPT_INFO 
$(term_color "1;34;40" $(scm_prompt_char))> '

    RPROMPT='$RPROMPT_SUFFIX'

    ZSH_THEME_GIT_PROMPT_PREFIX="on $(term_color_open '1;33;40')"
    ZSH_THEME_GIT_PROMPT_SUFFIX="$(term_color_reset)"
    ZSH_THEME_GIT_PROMPT_DIRTY=" $(term_color '1;31;40' '(!)')"
    ZSH_THEME_GIT_PROMPT_UNTRACKED=" $(term_color '1;34;40' '(+)')"
    ZSH_THEME_GIT_PROMPT_CLEAN=""
    ;;
esac
